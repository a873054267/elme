...
<div class="food" v-show="showFlag" :food="food" ref="food">
  <div class="food-content">
    ...
    <div class="rating">
      ...
      <ratingSelect @select="selectRatType" @toggleContent="toggleContent"   :ratings="food.ratings" :desc="desc" :selectType="selectType" :onlyContent="onlyContent"></ratingSelect>
